...
class VariableWidthLine {
    ...
    companion object {
        fun drawLine(
            ...
            drawPolygon(buildHullFromPolygon(line, size, minWidth, maxWidth), g2)
        }
        ...
        private fun buildHullFromPolygon(
            ...
            for (i in 1 until ppList.size) {
                ...
                leftHull.add(calculatePerpendicularPolyPoint(p0, p1, size, minWidth, maxWidth, alfaPlus90))
                rightHull.add(calculatePerpendicularPolyPoint(p0, p1, size, minWidth, maxWidth, alfaMinus90))
            }
